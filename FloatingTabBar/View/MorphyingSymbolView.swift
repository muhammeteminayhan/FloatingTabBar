...
struct MorphyingSymbolView: View {
    var symbol: String
    var config: Config
    // View Properities
...
#Preview {
    MorphyingSymbolView(symbol: "gearshape.fill", config: .init(font: .system(size: 100, weight: .bold), frame: CGSize(width: 250, height: 250), radius: 15, foregroundColor: .black))
}
